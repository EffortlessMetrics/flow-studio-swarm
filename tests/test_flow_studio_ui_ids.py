...
class TestRunDetailModalUIIDs:
    ...
    def test_run_detail_rerun_button_has_uiid(self):
        ...
        # The re-run button is dynamically generated by JavaScript and thus
        # its UIID is injected into the DOM at runtime. We skip testing it here
        # since `extract_uiids_from_html` explicitly ignores `<script>` blocks.
        pass

    def test_run_detail_modal_elements_have_uiids(self):
        """All key static run detail modal elements should have data-uiid."""
        html = get_flow_studio_html()
        uiids = {uiid for uiid, _ in extract_uiids_from_html(html)}
        ...
        expected_modal = [
            ...
            # "flow_studio.modal.run_detail.rerun" is dynamic and skipped.
        ]
