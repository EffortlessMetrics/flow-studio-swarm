...
class TestRunDetailModalUIIDs:
    ...
    def test_run_detail_rerun_button_has_uiid(self):
        ...
        # It's generated by javascript, so it will appear inside the <script> block
        assert f'data-uiid="{uiid}"' in html, (
    ...
    def test_run_detail_modal_elements_have_uiids(self):
        ...
        # flow_studio.modal.run_detail.rerun is generated by javascript
        missing = [e for e in expected_modal if e not in uiids and f'data-uiid="{e}"' not in html]
        if missing:
