...
def extract_uiids_from_html(html: str) -> List[Tuple[str, int]]:
    ...
    for line_num, line in enumerate(html.split("\n"), start=1):
        ...
        if script_start.search(line):
            # Special case for flowstudio-js-bundle which contains inlined HTML templates via esbuild
    ...
    # Deduplicate to prevent false duplicate errors from inlined JS templates
    seen = set()
    deduped_uiids = []
