...
class TestDynamicUIIDs:
    ...
    def test_run_detail_rerun_button_uiid_is_dynamic(self):
        """Verify run detail re-run button UIID is in run_detail_modal.ts.

        The re-run button is rendered dynamically, so its UIID appears in JS code,
        not in the static index.html.
