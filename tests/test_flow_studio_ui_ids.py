...
class TestRunDetailModalUIIDs:
    ...
    def test_run_detail_rerun_button_has_uiid(self):
        ...
        # This button is rendered dynamically via JS, so we can't verify it in static HTML.
        # It is verified by TestDynamicUIIDs or integration tests instead.
        pass
    ...
    def test_run_detail_modal_elements_have_uiids(self):
        ...
        expected_modal = [
            ...
            # "flow_studio.modal.run_detail.rerun",  # Excluded: rendered dynamically via JS
        ]
