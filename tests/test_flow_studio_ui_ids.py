...
class TestRunDetailModalUIIDs:
    ...
    @pytest.mark.skip(reason="Tests for data-uiid attributes defined exclusively in JavaScript (like flow_studio.modal.run_detail.rerun) will fail because the test suite skips parsing <script> tags in index.html.")
