...
class TestRunDetailModalUIIDs:
    ...
    def test_run_detail_modal_elements_have_uiids(self):
        ...
        # NOTE: flow_studio.modal.run_detail.rerun is rendered at runtime into
        # #run-detail-modal-content by run_detail_modal.ts, so it is verified by
        # TestDynamicallyRenderedUIIDs against the compiled JS instead.
        expected_modal = [
