    ...
    def test_create_fails_if_base_branch_missing(self, tmp_path):
        ...
        with patch.object(fork, "_run_git") as mock_git:
            ...
            with pytest.raises(RuntimeError, match="does not exist"):
                # We expect RuntimeError from checkout failing because resolve_base_ref
                # will fall back to "HEAD" which then gets passed to checkout if the tests
                # mock checkouts to fail. Actually, we want to test base branch logic.
