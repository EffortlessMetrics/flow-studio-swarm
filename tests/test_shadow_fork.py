...
class TestShadowForkCreate:
    ...
    def test_create_fails_if_base_branch_missing(self, tmp_path):
        ...
        # Patch _resolve_base_ref so we don't need to mock its internal git calls
        # We simulate resolution returning the bad branch, then checkout failing
        with patch.object(fork, "_run_git") as mock_git, \
            ...
            # Expect RuntimeError from the failed checkout
