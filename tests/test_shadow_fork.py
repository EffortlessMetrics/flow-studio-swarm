...
class TestShadowForkCreate:
    ...
    def test_create_falls_back_to_head_if_base_missing(self, tmp_path):
        ...
        with patch.object(fork, "_run_git") as mock_git:
            # We patch _resolve_base_ref to simulate fallback behavior explicitly
            # or rely on the implementation. Here we patch _resolve_base_ref to simplify.
    ...
    def test_create_warns_on_uncommitted_changes(self, tmp_path, caplog):
        ...
        with patch.object(fork, "_run_git") as mock_git:
            # Patch resolve_base_ref to avoid git calls for resolution
