...
class TestShadowForkCreate:
    ...
    def test_create_success(self, tmp_path):
        ...
        with patch.object(fork, "_run_git") as mock_git:
            mock_git.side_effect = [
                ...
                (True, "refs/heads/main", ""),  # Resolve base branch (rev-parse)
    ...
    def test_create_falls_back_to_head_if_base_branch_missing(self, tmp_path):
        ...
        with patch.object(fork, "_run_git") as mock_git:
            ...
            assert fork.shadow_branch is not None
    ...
    def test_create_warns_on_uncommitted_changes(self, tmp_path, caplog):
        ...
        with patch.object(fork, "_run_git") as mock_git:
            mock_git.side_effect = [
                ...
                (True, "refs/heads/main", ""),  # Resolve base branch
                (True, "", ""),  # Create and switch to shadow branch
                (True, "", ""),  # Install push guard
            ]
