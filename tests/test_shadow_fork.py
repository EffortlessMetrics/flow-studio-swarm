...
class TestShadowForkCreate:
    ...
    def test_create_fails_if_base_branch_missing(self, tmp_path):
        ...
        # This bypasses the fallback logic and ensures create() tries to checkout the missing branch
    ...
    def test_create_warns_on_uncommitted_changes(self, tmp_path, caplog):
        ...
        # Mock _resolve_base_ref to simplify mocking sequence (skip git calls in resolution)
