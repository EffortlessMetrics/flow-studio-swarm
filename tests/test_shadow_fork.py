...
class TestShadowForkCreate:
    ...
    def test_create_fails_if_base_branch_missing(self, tmp_path):
        ...
        # Patch _resolve_base_ref to return a value, preventing multiple git calls
        # We want to test that create() fails if checkout fails (which happens if ref is bad)
