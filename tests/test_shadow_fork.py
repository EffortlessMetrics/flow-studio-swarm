...
class TestShadowForkCreate:
    ...
    def test_create_success(self, tmp_path):
        ...
        with patch.object(fork, "_run_git") as mock_git, \
            ...
            mock_git.side_effect = [
                ...
                (True, "", ""),  # Check for uncommitted changes (empty=clean)
    ...
    def test_create_fails_if_base_branch_missing(self, tmp_path):
        ...
        # Note: ShadowFork.create now falls back to HEAD if base branch missing.
        # To test failure, we simulate checkout failing even with the resolved ref.
        fork = ShadowFork(repo_root=tmp_path)
        ...
        with patch.object(fork, "_run_git") as mock_git, \
            ...
            mock_git.side_effect = [
                ...
                (False, "", "fatal: checkout failed"),  # checkout fails
            ]
    ...
    def test_create_warns_on_uncommitted_changes(self, tmp_path, caplog):
        ...
        # Explicitly set log level to ensure capture
