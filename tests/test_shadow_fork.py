    ...
    def test_create_fails_if_base_branch_missing(self, tmp_path):
        ...
        with patch.object(fork, "_run_git") as mock_git:
            mock_git.side_effect = [
                ...
                (False, "", "fatal"),  # Base branch 'origin/nonexistent' doesn't exist
                (False, "", "fatal"),  # Base branch 'main' doesn't exist
                (False, "", "fatal"),  # Base branch 'origin/main' doesn't exist
                (False, "", "fatal"),  # Base branch 'master' doesn't exist
                (False, "", "fatal"),  # Base branch 'origin/master' doesn't exist
                (True, "", ""),  # Check for uncommitted changes
                (False, "", "fatal"),  # git checkout -b ... HEAD fails
            ]
