...
class TestShadowForkCreate:
    ...
    def test_create_fails_if_base_branch_missing(self, tmp_path):
        ...
        with patch.object(fork, "_run_git") as mock_git:
            mock_git.side_effect = [
                (True, "main", ""),  # Get current branch
                (False, "", "fatal"),  # Resolve base ref rev-parse nonexistent
                (False, "", "fatal"),  # Resolve base ref rev-parse origin/nonexistent
                (False, "", "fatal"),  # Resolve base ref rev-parse main
                (False, "", "fatal"),  # Resolve base ref rev-parse origin/main
                (False, "", "fatal"),  # Resolve base ref rev-parse master
                (False, "", "fatal"),  # Resolve base ref rev-parse origin/master
                (True, "", ""),  # Check for uncommitted changes
    ...
    def test_create_warns_on_uncommitted_changes(self, tmp_path, caplog):
        ...
        with patch.object(fork, "_run_git") as mock_git:
            mock_git.side_effect = [
                (True, "main", ""),  # Get current branch
                (True, "main", ""),  # Resolve base ref rev-parse
