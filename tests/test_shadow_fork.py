...
class TestShadowForkCreate:
    ...
    def test_create_fails_if_base_branch_missing(self, tmp_path):
        ...
        # Mock _resolve_base_ref to prevent fallback logic from masking the failure
        # and to simplify the _run_git side effects
        with patch.object(fork, "_resolve_base_ref", return_value="nonexistent"), \
            ...
            # Should raise RuntimeError from the failed checkout
    ...
    def test_create_warns_on_uncommitted_changes(self, tmp_path, caplog):
        ...
        # Mock _resolve_base_ref to simplify _run_git side effects
