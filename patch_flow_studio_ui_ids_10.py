...
# Make extract_uiids_from_html extract from script tag with flowstudio-js-bundle
new_extract_func = r'''def extract_uiids_from_html(html: str) -> List[Tuple[str, int]]:
    """
...
old_func = r'''def extract_uiids_from_html(html: str) -> List[Tuple[str, int]]:
    """
    Extract all data-uiid attribute values from HTML DOM elements.
...
content = content.replace(old_func, new_extract_func)
