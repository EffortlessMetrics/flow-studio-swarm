...
## 2024-06-29 - Native dict serialization over deepcopy
...
**Action:** Use from_dict(to_dict(x)) instead of copy.deepcopy for complex dataclasses to improve cloning performance.
