...
**Deprecated:** `route_step_unified` is an alias for backwards compatibility. It emits a `FutureWarning` on access and is removed in v4.0 - use `route_step` directly. See the migration table in [ROUTING_API.md](./ROUTING_API.md#deprecated-aliases).
