 ...
 */
export type FlowStudioUIID = "flow_studio.modal.shortcuts.close" | "flow_studio.modal.context_budget.input.recent" | "flow_studio.modal.run_detail.inventory" | "flow_studio.modal.selftest.body" | "flow_studio.modal.run_detail.boundary" | "flow_studio.modal.run_detail.boundary.toggle" | "flow_studio.sdlc_bar.flows" | "flow_studio.canvas.legend.content" | "flow_studio.canvas.empty" | "flow_studio.sidebar.run_control.stop" | "flow_studio.modal.selftest.close" | "flow_studio.sidebar.compare_selector.select" | "flow_studio.modal.context_budget.input.older" | "flow_studio.modal.run_detail.boundary.container" | "flow_studio.header.reload.copy_btn" | "flow_studio.modal.context_budget.input.total" | "flow_studio.inspector.teaching_notes_structured" | "flow_studio.modal.run_detail.inventory.container" | "flow_studio" | "flow_studio.header" | "flow_studio.header.search" | "flow_studio.header.search.input" | "flow_studio.header.search.results" | "flow_studio.header.controls" | "flow_studio.header.tour" | "flow_studio.header.tour.trigger" | "flow_studio.header.tour.menu" | "flow_studio.header.mode" | "flow_studio.header.mode.author" | "flow_studio.header.mode.operator" | "flow_studio.header.governance" | "flow_studio.header.governance.overlay" | "flow_studio.header.teaching_mode" | "flow_studio.header.teaching_mode.toggle" | "flow_studio.header.reload" | "flow_studio.header.reload.btn" | "flow_studio.header.help" | "flow_studio.header.profile" | "flow_studio.sdlc_bar" | "flow_studio.sdlc_bar.wisdom_indicator" | "flow_studio.sidebar" | "flow_studio.sidebar.run_selector" | "flow_studio.sidebar.run_selector.select" | "flow_studio.sidebar.compare_selector" | "flow_studio.sidebar.flow_list" | "flow_studio.sidebar.view_toggle" | "flow_studio.sidebar.view_toggle.agents" | "flow_studio.sidebar.view_toggle.artifacts" | "flow_studio.sidebar.backend_selector" | "flow_studio.sidebar.backend_selector.select" | "flow_studio.sidebar.inventory_counts" | "flow_studio.sidebar.run_control" | "flow_studio.sidebar.run_control.buttons" | "flow_studio.sidebar.run_control.play" | "flow_studio.sidebar.run_control.pause" | "flow_studio.sidebar.run_control.resume" | "flow_studio.sidebar.run_control.cancel" | "flow_studio.sidebar.run_control.status" | "flow_studio.sidebar.run_history" | "flow_studio.sidebar.run_history.filter" | "flow_studio.sidebar.run_history.list" | "flow_studio.inventory.counts" | "flow_studio.canvas" | "flow_studio.canvas.graph" | "flow_studio.canvas.legend" | "flow_studio.canvas.legend.toggle" | "flow_studio.canvas.outline" | "flow_studio.inspector" | "flow_studio.inspector.details" | "flow_studio.inspector.teaching_note" | "flow_studio.inspector.interruption_stack" | "flow_studio.modal.shortcuts" | "flow_studio.modal.selftest" | "flow_studio.modal.run_detail" | "flow_studio.modal.run_detail.close" | "flow_studio.modal.run_detail.body" | "flow_studio.modal.run_detail.rerun" | "flow_studio.modal.run_detail.exemplar" | "flow_studio.modal.run_detail.events.toggle" | "flow_studio.modal.run_detail.events.container" | "flow_studio.modal.run_detail.wisdom" | "flow_studio.modal.run_detail.wisdom.toggle" | "flow_studio.modal.run_detail.wisdom.container" | "flow_studio.modal.run_detail.wisdom.summary" | "flow_studio.modal.run_detail.wisdom.empty" | "flow_studio.modal.context_budget" | "flow_studio.modal.context_budget.close" | "flow_studio.modal.context_budget.effective" | "flow_studio.modal.context_budget.profile_form" | "flow_studio.modal.context_budget.reset" | "flow_studio.modal.context_budget.save" | "flow_studio.header.context_budget" | "flow_studio.header.context_budget.trigger" | "flow_studio.modal.boundary_review.panel" | "flow_studio.modal.boundary_review.content" | "flow_studio.modal.boundary_review.container" | "flow_studio.modal.boundary_review.approve" | "flow_studio.modal.boundary_review.pause";
/**
 ...
 */
export declare function qsByUiid<T extends HTMLElement = HTMLElement>(id: FlowStudioUIID | `flow_studio.canvas.outline.${"flow" | "step" | "agent" | "artifact"}:${string}` | `flow_studio.inventory.type.${string}` | `flow_studio.inventory.flow.${string}`): T | null;
/**
 ...
 */
export declare function qsAllByUiidPrefix<T extends HTMLElement = HTMLElement>(prefix: string): NodeListOf<T>;
/**
 ...
 * }
 */
export declare function waitForUIReady(timeoutMs?: number): Promise<FlowStudioSDK>;
/**
 ...
 * }
 */
export declare function getSDKIfReady(): FlowStudioSDK | null;
/**
