...
// Import utilities
import { formatDuration, formatTime, formatDateTime, createQuickCommands, createPathWithCopy, escapeHtml, copyToClipboard, initGlobalCopyHandler } from "./utils.js";
// ============================================================================
// Details Wrappers
// ============================================================================
...
window.addEventListener("load", async () => {
    ...
    try {
        ...
        // Initialize global copy handler (delegated)
         ...
         */
        function showFlowCompletedToast(flowKey, runId) {
        ...
        async function showBoundaryReviewPanel(flowKey, runId, scope = "flow") {
            try {
        ...
        configureRunControl({
            ...
            onRunComplete: (runId, isAutopilot) => {
                ...
                if (isAutopilot) {
                    ...
                    void showBoundaryReviewPanel(state.currentFlowKey || "signal", runId, "run");
                }
                else {
