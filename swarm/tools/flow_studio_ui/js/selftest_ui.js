    ...
    <div class="selftest-commands">
      ...
      ${commands.map(cmd => `
        <div class="selftest-command">
          ...
          <button class="selftest-command-copy-btn" aria-label="\ud83d\udccb Copy" data-uiid="flow_studio.selftest.copy" onclick="window.copyToClipboard && window.copyToClipboard('${escapeHtml(cmd).replace(/'/g, "\\'")}')" title="Copy">\ud83d\udccb</button>
        </div>
      `).join("")}
    </div>
  `;
