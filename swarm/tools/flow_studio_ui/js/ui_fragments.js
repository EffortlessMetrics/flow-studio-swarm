...
export function renderNoRuns() {
    ...
    <div class="fs-empty" style="padding: 16px 12px;">
      ...
      <div class="fs-copy-command">
        ...
        <button class="fs-icon-button copy-button" title="Copy command" aria-label="Copy 'make demo-run' to clipboard" onclick="navigator.clipboard.writeText('make demo-run'); this.textContent='✓'; setTimeout(() => this.textContent='📋', 2000)">📋</button>
      </div>
    </div>
  `;
}
