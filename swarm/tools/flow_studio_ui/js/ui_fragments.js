...
export function renderNoRuns() {
    ...
    <div class="fs-empty" style="padding: 16px 12px;">
      ...
      <div class="fs-copy-command">
        ...
        <button class="fs-icon-button copy-button" aria-label="\uD83D\uDCCB Copy command" data-uiid="flow_studio.canvas.copy" title="Copy command" onclick="navigator.clipboard.writeText('make demo-run'); this.textContent='\u2713'; setTimeout(() => this.textContent='\uD83D\uDCCB', 2000)">\uD83D\uDCCB</button>
      </div>
    </div>
  `;
}
