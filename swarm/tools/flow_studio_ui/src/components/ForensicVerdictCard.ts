...
const VERDICT_STYLES: Record<ForensicVerdictType, { color: string; bgColor: string; borderColor: string; icon: string }> = {
  PASS: {
    color: "#166534",
    bgColor: "#dcfce7",
    borderColor: "#22c55e",
...
export class ForensicVerdictCard {
  ...
  private onComparisonClick?: (comparison: ClaimEvidenceComparison, index: number) => void;
  private onVerdictClick?: (verdict: ForensicVerdictType) => void;

  private data: ForensicVerdict | null = null;
   ...
   */
  private createVerdictBadge(): HTMLElement {
   ...
   */
  private createRewardHackingSection(): HTMLElement {
    const section = document.createElement("div");
   ...
   */
  private createCriticalIssuesSection(): HTMLElement {
    const section = document.createElement("div");
   ...
   */
  private createClaimEvidenceSection(): HTMLElement {
    const section = document.createElement("div");
   ...
   */
  private createComparisonItem(comparison: ClaimEvidenceComparison, index: number): HTMLElement {
 ...
 */
export function createForensicVerdictCard(
  container: HTMLElement,
  data?: ForensicVerdict,
  options?: Omit<ForensicVerdictCardOptions, "container">
): ForensicVerdictCard {
