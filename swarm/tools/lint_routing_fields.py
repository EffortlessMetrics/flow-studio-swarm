...
SKIP_PATTERNS = [
    ...
    "**/swarm/prompts/agentic_steps/self-reviewer.md",  # Legacy patterns used for instructions/examples
    "**/docs/RELEASE_CHECKLIST.md",  # Legacy patterns used for checklist items
]
