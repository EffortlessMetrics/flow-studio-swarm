...
SKIP_PATTERNS = [
    ...
    "docs/RELEASE_CHECKLIST.md",  # Documents legacy patterns to avoid
    "swarm/prompts/agentic_steps/self-reviewer.md",  # Discusses legacy patterns in context of review
]
