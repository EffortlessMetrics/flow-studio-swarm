...
SKIP_PATTERNS = [
    ...
    "**/swarm/prompts/agentic_steps/self-reviewer.md",  # Documentation of new routing vs legacy
    "**/docs/RELEASE_CHECKLIST.md",  # Checklist items mentioning legacy patterns
]
