...
SKIP_PATTERNS = [
    ...
    "**/docs/RELEASE_CHECKLIST.md",  # Contains instructions mentioning the transition
    "**/swarm/prompts/agentic_steps/self-reviewer.md", # Contains documentation of transition
]
