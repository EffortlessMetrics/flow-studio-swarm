...
SKIP_PATTERNS = [
    ...
    "**/docs/RELEASE_CHECKLIST.md",  # Documents the grep command to find these patterns
    "**/swarm/prompts/agentic_steps/self-reviewer.md",  # Explains the migration from legacy fields
]
