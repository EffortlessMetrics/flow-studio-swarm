...
SKIP_PATTERNS = [
    ...
    "**/docs/RELEASE_CHECKLIST.md",  # Documents deprecated fields for removal instructions
    "**/swarm/prompts/agentic_steps/self-reviewer.md",  # Mentions deprecated fields as things to check for
]
