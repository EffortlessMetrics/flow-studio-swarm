...
SKIP_PATTERNS = [
    ...
    "**/docs/RELEASE_CHECKLIST.md", # Documentation referencing old paths
    "**/swarm/prompts/agentic_steps/self-reviewer.md", # Documentation for backward compatibility checks
]
