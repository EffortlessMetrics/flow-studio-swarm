...
SKIP_PATTERNS = [
    ...
    "**/swarm/prompts/agentic_steps/self-reviewer.md",  # Mentions deprecated fields as part of instructions
    "**/docs/RELEASE_CHECKLIST.md",  # Mentions deprecated fields as part of checklist
]
