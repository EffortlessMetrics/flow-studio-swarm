...
SKIP_PATTERNS = [
    ...
    "**/docs/RELEASE_CHECKLIST.md",  # Documentation references deprecated fields for checklist
    "**/swarm/prompts/agentic_steps/self-reviewer.md",  # Prompt references deprecated fields for explanation
]
