...
SKIP_PATTERNS = [
    ...
    "**/docs/RELEASE_CHECKLIST.md",  # Mentions deprecated fields in deprecation documentation
    "**/swarm/prompts/agentic_steps/self-reviewer.md", # Mentions deprecated fields in documentation
]
