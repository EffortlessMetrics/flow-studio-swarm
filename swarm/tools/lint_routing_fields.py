...
SKIP_PATTERNS = [
    ...
    "swarm/prompts/agentic_steps/self-reviewer.md",  # Mentions deprecated fields for context
    "docs/RELEASE_CHECKLIST.md",  # Mentions deprecated fields as check items
]
