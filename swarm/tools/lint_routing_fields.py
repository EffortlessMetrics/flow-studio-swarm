...
SKIP_PATTERNS = [
    ...
    "**/swarm/prompts/agentic_steps/self-reviewer.md",  # Prompt explains legacy vs new routing
    "**/docs/RELEASE_CHECKLIST.md",  # Release checklist greps for legacy patterns
]
