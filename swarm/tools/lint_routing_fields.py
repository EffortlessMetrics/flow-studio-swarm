...
SKIP_PATTERNS = [
    ...
    "**/docs/RELEASE_CHECKLIST.md",  # Release checklist documents deprecation steps
    "**/swarm/prompts/agentic_steps/self-reviewer.md",  # Self-reviewer checks for deprecated fields
]
