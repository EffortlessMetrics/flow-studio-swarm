...
SKIP_PATTERNS = [
    ...
    "**/docs/RELEASE_CHECKLIST.md",  # Checklists references legacy patterns for verification
    "**/swarm/prompts/agentic_steps/self-reviewer.md",  # Prompt explains legacy vs new patterns
]
