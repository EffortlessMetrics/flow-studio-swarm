...
SKIP_PATTERNS = [
    ...
    "**/swarm/prompts/agentic_steps/self-reviewer.md",  # Mentions deprecated fields in context
    "**/docs/RELEASE_CHECKLIST.md",  # Mentions deprecated fields in migration guide
]
