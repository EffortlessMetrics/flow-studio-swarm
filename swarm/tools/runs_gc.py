...
def get_dir_size(path: Path) -> int:
    ...
    total = 0
    stack = [str(path)]
    # Performance Optimization: Replaced Path.rglob("*") with a custom os.scandir stack.
    # os.scandir caches file attributes, bypassing the overhead of instantiating Path objects
    # for every item in large directories, drastically improving GC performance.
    while stack:
