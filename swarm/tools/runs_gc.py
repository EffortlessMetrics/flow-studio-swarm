...
def get_dir_size(path: Path) -> int:
    ...
    # PERFORMANCE OPTIMIZATION (Bolt): Using os.scandir is significantly faster than Path.rglob
    # for recursive directory traversal because it avoids creating intermediate Path objects.
    total = 0
    try:
