...
def get_dir_size(path: Path) -> int:
    ...
    # Path.rglob() instantiates Path objects for every single item and resolves full paths,
    # which is very slow when listing large run directories. os.scandir() yields lightweight
    # DirEntry objects with cached stats and is significantly faster.
