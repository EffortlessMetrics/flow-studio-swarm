...
def cmd_prune(args: argparse.Namespace) -> int:
    ...
    # Use compute_size=False to speed up discovery (skip size calculation for kept runs)
    ...
    # Lazily calculate size for runs to be deleted (for accurate reporting)
...
def cmd_quarantine(args: argparse.Namespace) -> int:
    ...
    # Skip size calculation for quarantine checks
    runs = discover_all_runs(compute_size=False)
