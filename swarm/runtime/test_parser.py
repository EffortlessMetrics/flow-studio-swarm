...
# SECURITY: Use defusedxml.ElementTree instead of the standard library xml.etree.ElementTree to prevent XXE (XML External Entity) vulnerabilities when parsing test results.
