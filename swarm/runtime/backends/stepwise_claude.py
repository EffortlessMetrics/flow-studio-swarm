"""stepwise_claude - Claude stepwise orchestrator backend adapter.

Adapts the Claude Agent SDK stepwise orchestrator to the RunBackend
interface (one LLM call per step rather than one per flow).
"""
