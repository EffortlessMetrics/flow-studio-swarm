...
class SpecManager:
    ...
    def list_runs(self, limit: int = 20) -> List[Dict[str, Any]]:
        ...
        # Sort run directory names efficiently using scandir, then instantiate Path objects and check existence
        # only for the ones we process, deferring expensive I/O operations.
