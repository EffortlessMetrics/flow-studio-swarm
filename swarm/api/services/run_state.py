...
class RunStateManager:
    ...
    def list_runs(self, limit: int = 20) -> List[Dict[str, Any]]:
        ...
        # Optimization: Collect all directories first, sort by mtime, then check for
        # run_state.json only on the top candidates. This avoids thousands of
        # stat calls for run_state.json when there are many runs.
        candidates = []
