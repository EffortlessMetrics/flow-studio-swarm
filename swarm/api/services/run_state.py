...
class RunStateManager:
    ...
    def list_runs(self, limit: int = 20) -> List[Dict[str, Any]]:
        ...
        # OPTIMIZATION: We defer checking for run_state.json existence until after sorting
        # by modification time. This drastically reduces system calls when there are
        # many directories but we only want the top few (limit).
        candidates = []
