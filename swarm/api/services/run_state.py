...
class RunStateManager:
    ...
    def list_runs(self, limit: int = 20) -> List[Dict[str, Any]]:
        ...
        # Optimization: Sort candidates by mtime BEFORE checking for run_state.json
        # This avoids expensive file existence checks for thousands of old runs
        candidates = []
        ...
        # entry.stat() is typically cached from scandir
