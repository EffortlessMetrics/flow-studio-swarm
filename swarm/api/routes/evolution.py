...
async def apply_evolution_patch_endpoint(
    ...
    # Validate the raw request.patch_id first before checking for ":"
    # But note: it might legitimately contain a ":" separating the run_id and patch_id!
    # Let's split first, then validate the parts.
