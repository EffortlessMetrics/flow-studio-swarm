...
async def get_wisdom_content(
    ...
    Raises:
        ...
        400: Invalid run_id or artifact_name.
    """
    try:
        run_id = validate_path_component(run_id, "run_id")
        artifact_name = validate_path_component(artifact_name, "artifact_name")
    except ValueError as e:
        raise HTTPException(status_code=400, detail=str(e))
...
async def apply_wisdom_patch(
    ...
    try:
        run_id = validate_path_component(run_id, "run_id")
        request.artifact_name = validate_path_component(request.artifact_name, "artifact_name")
    except ValueError as e:
        raise HTTPException(status_code=400, detail=str(e))
...
async def apply_wisdom_patches(
    ...
    Raises:
        ...
        400: Invalid run_id, patch_type, or policy.
    """
    try:
        run_id = validate_path_component(run_id, "run_id")
    except ValueError as e:
